function pattern = elementaryCellularAutomata(rule, n, width, randfrac, array)
...
function flipped =  fliparray(array)
for idx = find(array == 1)
   array(idx) = 2;
end
for idx = find(array == 0)
   array(idx) = 1;
end
flipped = array;
end
